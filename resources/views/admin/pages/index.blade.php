...
@section('content')
@include('admin._partials.contentheader', ['page_title' => '<strong>Páginas</strong>'])
<div class="row">
    <div class="col-lg-12">
        <div class="panel">
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($site->pages as $page)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($page->image != '')
                                                <img class="thumb" src="/{{$page->site->folder}}/images/pages/{{$page->image}}">
                                            @endif
                                        </td>
                                        ...
                                        <td class="text-right">
                                            ...
                                            @include('admin._components.buttons.delete', ['controller' => 'Admin\PagesController','site_id' => $page->site->id , 'id' => $page->id])</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
